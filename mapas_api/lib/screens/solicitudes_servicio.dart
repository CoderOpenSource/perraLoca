...
class _AssistanceRequestScreenState extends State<AssistanceRequestScreen> {
  ...
  Future<int?> obtenerClienteIdPorUserId(int userId) async {
    var url = Uri.parse('http://146.190.46.194/usuarios/clientes/');
  ...
  Future<void> enviarSolicitudAsistencia({
    ...
    var uri = Uri.parse(
        'http://146.190.46.194/solicitudes_asistencia/solicitudes-asistencia/');
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              GridView.builder(
                ...
                physics:
                    NeverScrollableScrollPhysics(), // Evita que el GridView tenga su propio scroll
  ...
  Widget _buildRecordButton() {
    if (isRecording) {
      ...
      return ElevatedButton.icon(
        ...
        label:
            Text('Pausar Reproducción', style: TextStyle(color: Colors.white)),
        style: ElevatedButton.styleFrom(
            backgroundColor: Theme.of(context).primaryColor),
      );
    } else {
